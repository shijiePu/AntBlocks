...
import { approval, approveListQuery } from "@szhz/tech-pc/service/register";
...
const Index: React.FC<IndexProps> = () => {
  ...
  const { loading, getPageData, handleReset, dataSource, pagination } = useSearchTable({
    // 接口地址需自定义
    requestFn: approveListQuery,
    form,
    extraParams: {
      processType: 'BIND_PERSON_MANAGER_OLD_ACCOUNT'
    },
  ...
  return <>
    <TechPageTitle>历史账号关联审核</TechPageTitle>
    ...
    <TechCard>
      <TechPageTitle
        ...
        type="table"
        actionNode={
          activeType !== '1' && <Dropdown menu={menuProps}>
