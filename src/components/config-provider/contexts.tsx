...
const test = {
  ...
  "nationality": {
    "China": "中国大陆",
    "Hong Kong(Special Administrative Region of China)": "香港(中国特别行政区)",
    "Macao(Special Administrative Region of China)": "澳门(中国特别行政区)",
    "Taiwan Province of China": "台湾(中国的省 )",
    "Albania": "阿尔巴尼亚",
...
// export const ConfigContext = createContext<ConfigContextProps>({ globalDict: test });
